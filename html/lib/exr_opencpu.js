...
$(document).ready(function(){
    ...
    /* Initiate opencpu interface.
     *
     * Takes one input argument which will be stored on $(document).data("exr_htmlfile")
     * and used later on to load the results of opencpu execution.
     *
     * Parameters
     * ==========
     * htmlfile : str
     *      name of the html file created by opencpu which contains
     *      the results of the execution (knitr::spin output).
     */
    $.fn.exr_opencpu = function(htmlfile) {

        // Store xml file name
        $(document).data("exr_htmlfile", htmlfile);

        // ============================================================
        // Setting up "CodeMirror". CodeMirror options:
        // ============================================================
        ...
        $.fn.update_tab_ocpuoutput = function() {
            var xmlfile = $(document).data("exr_htmlfile");
            console.log("Loading file " + xmlfile)
            $("#ocpuoutput").load("getFile.php", { file: xmlfile });
